...
import {ExampleSourceJournalModelDefaultFactory} from "./example-source-journal-model-default-factory";
...
describe('ExampleSourceJournalModelImpl tests', () => {
  ...
  describe('initialization logic tests including its factory', () => {
    it('should not initialize if given a handle with wrong type', function() {
      ...
      const model = new ExampleSourceJournalModelDefaultFactory().createSource(handle);
