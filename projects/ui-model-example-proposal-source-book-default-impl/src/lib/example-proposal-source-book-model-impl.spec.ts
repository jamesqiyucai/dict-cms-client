import {FakeReviewableBookSourceHandle} from '../../../ui-model-example-source-book-default-impl/src/lib/example-source-book-model-impl.spec';
import {EditableBookSourceHandle, SourceType} from 'service-source';
import {ExampleProposalSourceBookModelDefaultFactory} from './example-proposal-source-book-model-default-factory';
...
describe('ExampleProposalSourceBookModelImpl tests', () => {
  ...
  describe('initialization logic tests including its factory', () => {
    it('should not initialize if given a handle with wrong type', function() {
      ...
      const model = new ExampleProposalSourceBookModelDefaultFactory().createSource(handle);
  ...
  describe('author empty test', () => {
    ...
    it('should emit false if author is not empty', function() {
      const model2 = new ExampleProposalSourceBookModelDefaultFactory().createSource(handle);
