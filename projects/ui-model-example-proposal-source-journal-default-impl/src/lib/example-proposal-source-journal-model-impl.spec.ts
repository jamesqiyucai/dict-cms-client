import {FakeReviewableJournalSourceHandle} from '../../../ui-model-example-source-journal-default-impl/src/lib/example-source-journal-model-impl.spec';
import {EditableJournalSourceModelFactory} from './example-proposal-source-journal-model-default-factory';
import {ExampleProposalSourceJournalModelImpl} from './example-proposal-source-journal-model.impl';
import {ExampleProposalSourceJournalModel} from '../../../ui-model-example-proposal-source-journal/src/lib/example-proposal-source-journal-model';
